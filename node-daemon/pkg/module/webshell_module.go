...
func UpdateWebShellState(newWebshell *model.WebShellAllocRequest, oldWebshell *model.WebShellAllocRequest) error {
	...
	if newWebshell.WebShellID != oldWebshell.WebShellID {
		...
		// else {
		// 	webShellInfo, err := synchronizer.GetWebshellInfo(key.NodeIndex, oldWebshell.WebShellID)
		// 	if err != nil {
		// 		return fmt.Errorf("get webshell info error: %s", err.Error())
		// 	}
		// 	err = utils.KillWebShell(webShellInfo.Pid)
		// 	if err != nil {
		// 		return fmt.Errorf("kill webshell error: %s", err.Error())
		// 	}
		// 	err = synchronizer.DelGetWebshellInfo(key.NodeIndex, oldWebshell.WebShellID)
		// 	if err != nil {
