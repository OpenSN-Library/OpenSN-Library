...
class CompleteVideoClient:
    ...
    def create_multicast_client_video_socket(self):
        ...
        for i in range(self.destinationNodeNum):
...
def start_multi_unicast_routing():
    enableLipsin = False
    transmissionPatternChoices = TransmissionPattern.multi_unicast
    destinationPort = 38788
    video_path = "movie_clip.mp4"
    complete_video_client = CompleteVideoClient(enableLipsin,
                                                transmissionPatternChoices,
                                                destinationPort,
                                                video_path)
    complete_video_client.destinationNodeNum = 2
    complete_video_client.destinationNodeList = [47, 46]
